<section class="ps-section ps-section--offer pt-80 pb-100">
            <div class="container">
                ...
                <div class="ps-section__content">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            ...
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href=""></a><img src="view/images/cake/img-cake-13.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-14.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            <div class="ps-badge"><span>-50%</span></div>
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-21.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                            ...
                            <div class="ps-product__content"><a class="ps-product__title" href="product-detail.html">Cupcake Queen 2</a>
                                <div class="ps-product__category"><a class="ps-product__category" href="product-listing.html">cupcake</a><a class="ps-product__category" href="product-listing.html">sweet</a><a class="ps-product__category" href="product-listing.html">bio</a>
                                </div>
                                <select class="ps-rating">
                        <option value="1">1</option>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            ...
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-15.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            <div class="ps-badge"><span>-50%</span></div>
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-16.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-17.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            <div class="ps-badge"><span>-50%</span></div>
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-18.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                        <div class="ps-product">
                            <div class="ps-badge ps-badge--new"><span>New</span></div>
                            <div class="ps-product__thumbnail">
                                <a class="ps-product__overlay" href="product-detail.html"></a><img src="view/images/cake/img-cake-20.jpg" alt="">
                                <ul class="ps-product__action">
                                    <li><a class="popup-modal" href="#quickview-modal" data-effect="mfp-zoom-out" data-tooltip="View"><i class="ps-icon--search"></i></a></li>
                                    <li><a href="#" data-tooltip="Add to wishlist"><i class="ps-icon--heart"></i></a></li>
                                    <li><a href="#" data-tooltip="Compare"><i class="ps-icon--reload"></i></a></li>
        ...
        <div class="ps-section ps-section--pattern pt-80 pb-80">
            <div class="container">
                <div class="ps-countdown">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 "><img src="view/images/counter.png" alt="">
                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                <div class="slick ps-cake-list">
                                    <div class="slick-item">
                                        <a class="ps-cake" href="javascript:;"><img src="view/images/special/img-cr-1.jpg" alt=""></a>
                                    </div>
                                    <div class="slick-item">
                                        <a class="ps-cake" href="javascript:;"><img src="view/images/special/img-cr-2.jpg" alt=""></a>
                                    </div>
                                    <div class="slick-item">
                                        <a class="ps-cake" href="javascript:;"><img src="view/images/special/img-cr-3.jpg" alt=""></a>
                                    </div>
                                    <div class="slick-item">
                                        <a class="ps-cake" href="javascript:;"><img src="view/images/special/img-cr-4.jpg" alt=""></a>
                                    </div>
                                    <div class="slick-item">
                                        <a class="ps-cake" href="javascript:;"><img src="view/images/special/img-cr-5.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                                <div class="slick ps-cake-detail">
                                    <div class="ps-cake--detail ps-cake--detail--2">
                                        <div class="ps-cake__thumbnail"><img src="view/images/special/small01.jpg" alt="">
                                    ...
                                    <div class="ps-cake--detail ps-cake--detail--2">
                                        <div class="ps-cake__thumbnail"><img src="view/images/special/small02.jpg" alt="">
                                        </div>
                                        <div class="ps-cake__content">
                                            <h3>Vanilla cupcake with red sugar flowers</h3>
                                            <p>INGREDIENTS:</p>
                                    ...
                                    <div class="ps-cake--detail ps-cake--detail--2">
                                        <div class="ps-cake__thumbnail"><img src="view/images/special/small03.jpg" alt="">
                                            <div class="ps-badge ps-badge--large"><span>HOT</span></div>
                                        </div>
                                        <div class="ps-cake__content">
                                            <h3>Vanilla cupcake with red sugar flowers</h3>
                                    ...
                                    <div class="ps-cake--detail ps-cake--detail--2">
                                        <div class="ps-cake__thumbnail"><img src="view/images/special/small04.jpg" alt="">
                                        </div>
                                        <div class="ps-cake__content">
                                            <h3>Vanilla cupcake with red sugar flowers</h3>
                                            <p>INGREDIENTS:</p>
                                    ...
                                    <div class="ps-cake--detail ps-cake--detail--2">
                                        <div class="ps-cake__thumbnail"><img src="view/images/special/small05.jpg" alt="">
                                            <div class="ps-badge ps-badge--large"><span>HOT</span></div>
                                        </div>
                                        <div class="ps-cake__content">
                                            <h3>Vanilla cupcake with red sugar flowers</h3>
                        ...
                        <div class="ps-section__content">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                    <article class="ps-people">
                                        <div class="ps-people__thumbnail">
                                            <a class="ps-people__overlay" href="#"></a><img src="view/images/team/team-1.jpg" alt=""></div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                    <article class="ps-people">
                                        <div class="ps-people__thumbnail">
                                            <a class="ps-people__overlay" href="#"></a><img src="view/images/team/team-2.jpg" alt=""></div>
                                        <div class="ps-people__content">
                                            <h4>Christian Gregory</h4><span class="ps-people__position">CEO - Founder</span>
                                            <p>Jelly topping halvah caramels sweet cake gummi bears toffee.</p>
                                            <ul class="ps-people__social">
                        ...
                        <div class="ps-masonry">
                            ...
                            <div class="grid-item high wide">
                                <div class="grid-item__content-wrapper">
                                    <div class="ps-offer"><img src="view/images/offer/banner-1.jpg" alt="">
                            ...
                            <div class="grid-item">
                                <div class="grid-item__content-wrapper">
                                    <div class="ps-offer"><img src="view/images/offer/banner-2.jpg" alt="">
                                        <a class="ps-offer__overlay" href="#"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="grid-item high">
                                <div class="grid-item__content-wrapper">
                                    <div class="ps-offer"><img src="view/images/offer/banner-3.jpg" alt="">
                                        <a class="ps-offer__overlay" href="#"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="grid-item wide">
                                <div class="grid-item__content-wrapper">
                                    <div class="ps-offer"><img src="view/images/offer/banner-4.jpg" alt="">
                                        <a class="ps-offer__overlay" href="#"></a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="ps-section ps-section--partner">
            <div class="container">
                <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="40" data-owl-nav="false" data-owl-dots="false" data-owl-animate-in="" data-owl-animate-out="" data-owl-item="6" data-owl-item-xs="3" data-owl-item-sm="4"
                    data-owl-item-md="5" data-owl-item-lg="6" data-owl-nav-left="&lt;i class=&quot;fa fa-angle-left&quot;&gt;&lt;/i&gt;" data-owl-nav-right="&lt;i class=&quot;fa fa-angle-right&quot;&gt;&lt;/i&gt;">
                    <a href="#"><img src="view/images/partner/1.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/2.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/3.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/4.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/5.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/6.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/7.png" alt=""></a>
                    <a href="#"><img src="view/images/partner/8.png" alt=""></a>
                </div>
            </div>
        </div>
                ...
                <div class="ps-subscribe">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 ">
                            <a class="ps-subscribe__logo" href="index.html"><img src="view/images/logo-1.png" alt=""></a>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 ">
